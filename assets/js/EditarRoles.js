 ...
 function searchTable() {
  ...
  const urlParams = new URLSearchParams(window.location.search);
        ...
        document.getElementById('guardar').addEventListener('click', function () {
            ...
            // Puedes realizar acciones para guardar los cambios aquí
            // Por ejemplo, enviar los datos al servidor o actualizar una base de datos
            console.log(`ID del Rol: ${id}, Nombre del Rol: ${nombre}, Nuevo Valor: ${nuevoValor}`);
